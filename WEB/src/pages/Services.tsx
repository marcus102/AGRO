        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <motion.div variants={staggerContainer} className="text-center">
            ...
            >
              ...
              <Link
                to="/contact"
                className="inline-flex items-center px-8 py-4 border-2 border-white text-base font-medium rounded-full text-white hover:bg-white hover:text-primary-DEFAULT transition-colors duration-200"
              >
                  ...
                  <ul className="mt-8 space-y-4">
                    {service.features.map((feature) => (
                      <li key={feature} className="flex items-start">
                        <Check className="h-5 w-5 text-primary-DEFAULT flex-shrink-0 mr-3" />
          ...
          <div className="px-6 py-12 sm:px-12 sm:py-16 lg:flex lg:items-center lg:justify-between">
            <div>
              <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl font-montserrat">
                <span className="block">
                  {translations.services.readyToGetStarted}
                </span>
                <span className="block text-primary-light">
                  {translations.services.joinOurNetwork}
                </span>
              </h2>
              <p className="mt-4 text-lg text-gray-400">
                {translations.services.connect}
              </p>
            </div>
            <div className="mt-8 lg:mt-0 lg:flex-shrink-0">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  {translations.services.createAccountButton}
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-base font-medium rounded-full hover:bg-white text-gray-500 hover:text-primary-DEFAULT transition-colors duration-200"
                >
                  {translations.services.contactUsButton}
                </Link>
              </div>
            </div>
          </div>
