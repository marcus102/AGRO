...
export function Contact({ translations }: ContactProps) {
  const contactInfo = [
    {
      ...
      details: ["123 Agro Street", "Farmington, AG 12345", "Burkina Faso"],
    },
    {
      icon: Phone,
  ...
  return (
    <div className="bg-background-light min-h-screen">
      ...
      <Layout>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 align-items-center w-full ">
          {/* Contact Information */}
                ...
                return (
                  ...
                  >
                    <div className="bg-primary-light/10 p-3 rounded-full">
                      <Icon className="h-6 w-6 text-primary-DEFAULT" />
                    </div>
                    <div>
