    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link to="/admin/users" className="font-medium text-primary-DEFAULT hover:text-primary-dark">
                View all users
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="flex items-baseline">
                    <div className="text-2xl font-semibold text-gray-900">{stats.activeMissions}</div>
                    <div className="ml-2 flex items-baseline text-sm font-semibold text-green-600">
                      <ArrowUpRight className="self-center flex-shrink-0 h-5 w-5" />
                      <span className="sr-only">Increased by</span>
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link to="/admin/missions" className="font-medium text-primary-DEFAULT hover:text-primary-dark">
                View all missions
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link to="/admin/payments" className="font-medium text-primary-DEFAULT hover:text-primary-dark">
                View all payments
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link to="/admin/blog" className="font-medium text-primary-DEFAULT hover:text-primary-dark">
                View all posts
              </Link>
            </div>
          </div>
