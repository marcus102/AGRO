      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
        <div className="bg-white rounded-lg p-4 shadow">
          <div className="flex items-center">
            <DollarSign className="h-6 w-6 text-primary-DEFAULT" />
            <span className="ml-2 text-sm font-medium text-gray-500">Total Revenue</span>
          </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow">
          ...
          <p className="mt-2 text-2xl font-semibold text-gray-900">{stats.completed}</p>
        </div>
        <div className="bg-white rounded-lg p-4 shadow">
          <div className="flex items-center">
        ...
        <div className="bg-white rounded-lg p-4 shadow">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-sm font-medium text-gray-500">Failed</span>
          </div>
          <p className="mt-2 text-2xl font-semibold text-gray-900">{stats.failed}</p>
        </div>
        <div className="bg-white rounded-lg p-4 shadow">
          <div className="flex items-center">
            <AlertTriangle className="h-6 w-6 text-gray-500" />
            <span className="ml-2 text-sm font-medium text-gray-500">Refunded</span>
          </div>
          <p className="mt-2 text-2xl font-semibold text-gray-900">{stats.refunded}</p>
        </div>
      </div>
