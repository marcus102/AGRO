  ...
  return (
    <div className="bg-background-light min-h-screen">
      ...
      <Layout>
        ...
        <motion.div variants={fadeIn} className="max-w-2xl mx-auto mb-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-DEFAULT focus:border-transparent shadow-sm"
            />
          </div>
        </motion.div>
        ...
        >
          <MessageCircle className="h-12 w-12 text-primary-DEFAULT mx-auto mb-4" />
          ...
          <Link
            to="/contact"
            className="inline-flex items-center px-8 py-3 border border text-base font-medium rounded-full hover:text-white bg-primary-DEFAULT hover:bg-primary-dark transition-colors duration-200"
          >
