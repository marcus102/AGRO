            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="pl-10 w-full rounded-lg border-gray-300 focus:ring-primary-DEFAULT focus:border-primary-DEFAULT"
                />
              </div>
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 rounded-lg border-gray-300 focus:ring-primary-DEFAULT focus:border-primary-DEFAULT"
                >
              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="px-3 py-1 bg-primary-DEFAULT text-white text-sm font-medium rounded-full">
                      {post.theme}
                    </span>
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <h2 className="text-xl font-semibold text-gray-900 mb-3 line-clamp-2">
                    <Link
                      to={`/blog/${post.id}`}
                      className="hover:text-primary-DEFAULT transition-colors duration-200"
                    >
                      {post.title}
                    </Link>
                  </h2>
                  ...
                  <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-100">
                    <div className="flex items-center">
                      <BookOpen className="h-4 w-4 text-primary-DEFAULT mr-2" />
                      <span className="text-sm text-gray-600">{`${translations.blog.by} Agro`}</span>
                    </div>
                    <Link
                      to={`/blog/${post.id}`}
                      className="inline-flex items-center text-primary-DEFAULT hover:text-primary-dark font-medium text-sm transition-colors duration-200"
                    >
