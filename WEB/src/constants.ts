...
export const translations = {
  en: {
    ...
    faq: {
      ...
      description:
        "Find answers to common questions about AgroNetwork and how it can help you succeed in agriculture.",
      ...
      question1: {
        ...
        answer:
          "AgroNetwork is a professional networking platform designed specifically for the agricultural industry. We connect farmers, agricultural technicians, and entrepreneurs to facilitate collaboration, knowledge sharing, and business growth.",
      },
      question2: {
  ...
  fr: {
    ...
    faq: {
      ...
      description:
        "Trouvez des réponses aux questions courantes sur AgroNetwork et comment il peut vous aider à réussir dans l'agriculture.",
      ...
      question1: {
        question: "Qu'est-ce qu'AgroNetwork ?",
        answer:
          "AgroNetwork est une plateforme de réseautage professionnel conçue spécifiquement pour l'industrie agricole. Nous connectons agriculteurs, techniciens agricoles et entrepreneurs pour faciliter la collaboration, le partage de connaissances et la croissance commerciale.",
      },
      question2: {
        question:
      ...
      question4: {
        question: "Comment AgroNetwork soutient-il les agro-entrepreneurs ?",
        answer:
    ...
    privacyPolicy: {
      ...
      lastUpdated: "Dernière mise à jour",
      description:
        "AgroNetwork prend votre vie privée au sérieux. Cette politique décrit comment nous collectons, utilisons et protégeons vos informations personnelles.",
