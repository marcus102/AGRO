        ...
        <div className="w-full py-6 flex items-center justify-between">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-montserrat font-bold text-primary-DEFAULT dark:text-primary-light">
                Agro
              </span>
            </Link>
          </div>
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-8">
              ...
              >
                ...
                {location.pathname === item.href && (
                  <motion.div
                    ...
                    className="absolute -bottom-1 left-0 right-0 h-0.5 bg-primary-DEFAULT dark:bg-primary-light"
                    initial={false}
            ...
            <div className="relative">
              <select
                ...
                className="p-2 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-700 dark:text-gray-300 hover:border-primary-DEFAULT dark:hover:border-primary-light focus:outline-none focus:ring-2 focus:ring-primary-DEFAULT dark:focus:ring-primary-light bg-transparent"
              >
